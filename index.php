...
$user_name = 'Anastasia'; // укажите здесь имя
...
/** 
 * Форматирует цену
 * @param int $price - изначальная цена
 * @return string - Отформатироанная цена
*/
    ...
    <section class="promo">
        ...
        <ul class="promo__list">
            ...
            <li class="promo__item promo__item--<?= $category_key ?>">
                <a class="promo__link" href="pages/all-lots.html"><?= $category_value ?></a>
            </li>
            <?php endforeach; ?>
        </ul>
    </section>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            ...
            <?php foreach ($categories as $category_key => $category_value) : ?>
            <li class="nav__item">
                <a href="pages/all-lots.html"><?= $category_value ?></a>
            </li>
            <?php endforeach; ?>
        </ul>
    </nav>
